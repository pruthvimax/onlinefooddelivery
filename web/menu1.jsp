...
<% 
    try{
        ...
        String phno=hs.getAttribute("phno").toString();
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            <a href="menu1.jsp" class="nav-item nav-link active ">view menu</a>
                            <a href="history.jsp" class="nav-item nav-link  ">Order History</a>
...
<center> <h1> <u>Food Menu</u></h1></center>
                 <%
                  ...
                  String cname=res.getString("name");
                                         out.println("<center><h3><tr><th>"+cname+"</th></tr></h3></center> ");
             ...
             ResultSet res1=stat1.executeQuery("SELECT * FROM menu WHERE cid='"+cid+"';");
               // out.println("SELECT * FROM menu WHERE cid='"+cid+"';");
                    ...
                    while(res1.next())
                  {
                     ...
                     String foodid=res1.getString("id");
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                ...
                                                <center>  <form action="userorder" method="POST">
                                                  <a class="btn btn-primary py-1 px-2 mt-1" href="userorder?id=<% out.println(foodid); %>"> place Order</a></center>
                                                </form>
                                                <span class="text-primary">Rs.<% out.println(price);%></span>
                                            </h5>
