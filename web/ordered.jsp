        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">VIEW ORDER</h1>
                </div>
             </div>
        </div>
   
                          <div class="container">
        <h1 class="mb-5">VIEW Supplied ORDER</h1>
             <table id="customers">
                  <thead>                 
                  <tr>
                  ...
                  ResultSet res=stat.executeQuery("SELECT * FROM `order` where status='supplied'");
                  int slno=0;               
                  while(res.next())
                  {
                      slno++;
                   ...
                   out.println("<tr><td>"+slno+"</td><td>"+id+"</td><td>"+foodid+"</td>><td>"+foodname+"</td><td>"+price+"</td><td>"+time+"</td><td>"+uid+"</td></tr>");
                  }
                   %>
